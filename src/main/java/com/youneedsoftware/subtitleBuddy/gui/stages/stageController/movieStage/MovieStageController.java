package com.youneedsoftware.subtitleBuddy.gui.stages.stageController.movieStage;
...
import com.youneedsoftware.subtitleBuddy.util.vec2d.VectorDecodeException;
...
import com.youneedsoftware.subtitleBuddy.srt.SubtitleType;
import com.youneedsoftware.subtitleBuddy.srt.font.fontManager.SrtFontManager;
import com.youneedsoftware.subtitleBuddy.util.ExecutionLimiter;
import com.youneedsoftware.subtitleBuddy.util.FXUtils.DragResizeMod;
...
public class MovieStageController extends AbstractStageController implements MovieSrtDisplayer {
    ...
    public void displaySubtitle(SubtitleText subtitleText) {
        log.debug("asking javafx to display new subtitle on MovieStage : " + subtitleText);
