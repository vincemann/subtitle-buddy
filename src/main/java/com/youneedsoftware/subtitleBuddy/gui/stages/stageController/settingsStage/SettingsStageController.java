package com.youneedsoftware.subtitleBuddy.gui.stages.stageController.settingsStage;
...
public class SettingsStageController extends AbstractStageController implements SettingsSrtDisplayer {
    ...
    protected Table<Node, EventHandler, EventType> registerEventHandlers() {
        ...
        //todo auslagern in austauschbare events + eventhandler -> business/srtParser/logik von gui trennen
        ...
        EventHandler<MouseEvent> optionsButtonPressedHandler = event ->optionsWindow.openOptionsWindow();
    ...
    public void displaySubtitle(@NonNull SubtitleText subtitleText) {
        log.trace("asking javafx to display new subtitle on SettingsStage : " + subtitleText);
